...
var Game = new function() {
  ...
  // Handle Input
  var KEY_CODES = { 37:'left', 39:'right', 32 :'claim' };
  this.keys = {};
...
var TitleScreen = function TitleScreen(title,subtitle,callback) {
  ...
  this.step = function(dt) {
    if(!Game.keys['claim']) up = true;
    if(up && Game.keys['claim'] && callback) callback();
  };
...
var TouchControls = function() {
  ...
  this.draw = function(ctx) {
    ...
    this.drawSquare(ctx,4*unitWidth,yLoc,"C",Game.keys['claim']);
  ...
  this.trackTouch = function(e) {
    ...
    if(e.type == 'touchstart' || e.type == 'touchend') {
      for(i=0;i<e.changedTouches.length;i++) {
        ...
        x = touch.pageX / Game.canvasMultiplier - Game.canvas.offsetLeft;
        if(x > 4 * unitWidth) {
          Game.keys['claim'] = (e.type == 'touchstart');
        }
      }
    }
  };
...
var GamePoints = function() {
  ...
  this.draw = function(ctx) {
    ...
    var txt = "Items Completed:" + Game.points;
